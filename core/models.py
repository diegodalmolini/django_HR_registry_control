...
class Benefits(models.Model):
    ...
    benefit = models.CharField('Benificio', max_length=12, help_text='Escolha o tipo de plano:')
    ...
    def __str__(self):
        return f'{self.user} - {self.benefit} - {self.value}'
...
class Employee(models.Model):
    ...
    labor_data = models.OneToOneField(Labor_data, verbose_name='Dados laborais', on_delete=models.CASCADE)
