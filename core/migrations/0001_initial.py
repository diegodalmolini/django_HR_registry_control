    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('benefit', models.CharField(choices=[('saude/personal', 'Plano de saúde/Personal'), ('saude/nacional', 'Plano de saúde/Nacional'), ('odontologico/c/protese', 'Plano odontológico com prótese'), ('odontologico/s/protese', 'Plano odontológico sem prótese')], help_text='Escolha o tipo de plano:', max_length=22, verbose_name='Benificio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('people', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.people', verbose_name='Pessoas')),
